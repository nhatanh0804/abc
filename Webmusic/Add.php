    ...
    <div class="container">
        <div class="row justify-content-center">
			...
			<div class="form-group">
                ...
                <input class="form-control"  name="Singer" type="text">
            </div>
			<div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="file" name="SongImage" id="priceproduct" class="form-control">
            </div>
            <div class="form-group">
            ...
            <button name="Add" type="submit" class="form-control btn btn-primary">Add</button>
                ...
                if(isset($_POST['Add'])){
					...
					move_uploaded_file($_FILES['MP3']['tmp_name'],$target2);
                        $result2=$conn->query("INSERT INTO `Song`(`SongName`, `Price`, `Singer`, `Lyrics`, `GenreID`,`SongImage`,`MP3`) VALUES('$SongName','$Price','$Singer','$Lyrics','$Genre','$SongImage','$MP3')");
                        if($result2){
